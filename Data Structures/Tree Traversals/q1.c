/*
 * This program was created by alex lai
 * this is an unfinnished c program that takes in a fully parentasized
 * arithmetic expression and has various funcitons to evaluate, update,
 * print in certain order and display as a tree
 * Date: November7th 2016 
 * Student NO: 0920158
 * Email : alai02@mail.uoguelph.ca
*/
#include <stdio.h> //included librarys
#include <stdlib.h>
#include <string.h>
...
typedef struct Tree { //Tree contains an operator and 2 nodes 
    ...
    struct Tree *right;
} Tree; //typedef the struc

void preOrder(Tree *root); //init all the functions because of implicit declaration
